...
export const useAppStore = create<AppState>()(
  persist(
    (set, get) => ({
      ...
      setBackgroundRotation: (type, category) =>
        set({
      ...
      refreshBackground: () => {
        ...
        set({
          background: getBackgroundByRotationType(
            backgroundRotation,
            selectedCategory
          ),
        });
      ...
      refreshQuote: () => {
        ...
        set({
          quote:
            quoteRotation === 'daily' ? getQuoteOfTheDay() : getRandomQuote(),
        });
      },

      setQuoteRotation: type =>
        set({
          quoteRotation: type,
